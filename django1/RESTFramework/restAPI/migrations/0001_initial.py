# Generated by Django 3.1.7 on 2021-04-14 01:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='restAPI.projects')),
        ...
        migrations.AddField(
            model_name='projects',
            name='members',
            field=models.ManyToManyField(through='restAPI.UserProject', to=settings.AUTH_USER_MODEL),
        ),
    ]
