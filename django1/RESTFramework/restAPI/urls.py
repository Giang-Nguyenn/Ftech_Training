...
urlpatterns = [
    ...
    path('project/user', views.ProjectListUser.as_view({'get':'list','post':'create'}),name='project-list-user'),
    # path('project/add_user', views.ProjectListUser.as_view({'post':'create'}),name='project-list-user'),
